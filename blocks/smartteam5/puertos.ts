...
function puertoToGpioPin(puerto: Ext5Puerto): DigitalPin {
    switch (puerto) {
        ...
        case Ext5Puerto.P5: return DigitalPin.P12;
        case Ext5Puerto.P6: return DigitalPin.P16;
        default:
...
function puertoToUltrasonicTrigEcho(puerto: Ext5Puerto): { trig: DigitalPin; echo: DigitalPin } {
    switch (puerto) {
        ...
        case Ext5Puerto.P2: return { trig: DigitalPin.P14, echo: DigitalPin.P1 };
        case Ext5Puerto.P3: return { trig: DigitalPin.P15, echo: DigitalPin.P2 };
        case Ext5Puerto.P4: return { trig: DigitalPin.P7, echo: DigitalPin.P8 };
        case Ext5Puerto.P5: return { trig: DigitalPin.P9, echo: DigitalPin.P12 };
        case Ext5Puerto.P6: return { trig: DigitalPin.P10, echo: DigitalPin.P16 };
        default:
            const _exhaustiveCheck: never = puerto;
            return _exhaustiveCheck;
    }
