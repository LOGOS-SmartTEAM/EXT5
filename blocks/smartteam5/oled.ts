...
namespace ext5_smartteam5 {
     ...
     * @param fila fila de la OLED (0–3), eg: Ext5OledFila.F0
     * @param columna columna de la OLED (0–15), eg: Ext5OledColumna.C0
     */
    ...
    export function showString(texto: any, fila: Ext5OledFila, columna: Ext5OledColumna): void {
        ensureOledInit()
        clearFila(fila)
        const s = "" + texto
